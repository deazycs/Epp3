...
const DOCS = [
  { id:'d1', name:'Договор РЗ-2026-00142/Д с ООО ТехноОфис', file:'Договор_РЗ-2026-00142.pdf', cat:'contract', status:'approved', size:'912 КБ', date:'2026-04-18', author:'Козлов Д.М.', proc:'РЗ-2026-00142' },
  ...
  { id:'d3', name:'Счёт-фактура № 112 от 18.04.2026', file:'СФ_112_ТехноОфис.pdf', cat:'invoice', status:'review', size:'98 КБ', date:'2026-05-02', author:'Волкова Е.И.', proc:'РЗ-2026-00142' },
  { id:'d4', name:'Договор РЗ-2026-00098/Д с ООО МоскваСофт', file:'Договор_РЗ-2026-00098.pdf', cat:'contract', status:'approved', size:'845 КБ', date:'2026-02-10', author:'Козлов Д.М.', proc:'РЗ-2026-00098' },
  ...
  { id:'d8', name:'Обоснование НМЦК — серверное оборудование', file:'НМЦК_серверы_2026.docx', cat:'justification', status:'approved', size:'175 КБ', date:'2026-02-20', author:'Никитин П.А.', proc:'РЗ-2026-00089' },
  { id:'d9', name:'Договор РЗ-2026-00056/Д с ЗАО КанцЛайф', file:'Договор_РЗ-2026-00056.pdf', cat:'contract', status:'approved', size:'678 КБ', date:'2026-01-28', author:'Козлов Д.М.', proc:'РЗ-2026-00056' },
  { id:'d10', name:'Шаблон ТЗ (товары, типовой)', file:'Шаблон_ТЗ_товары.docx', cat:'template', status:'approved', size:'52 КБ', date:'2026-01-10', author:'Козлов Д.М.', proc:'' },
];
    ...
    <AppLayout>
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="gov-btn gov-btn-secondary gov-btn-sm"><Upload size={12}/> Загрузить</button>
        </div>

        <div className="grid grid-cols-4 gap-2 mb-3">
          {[
            {label:'Договоры', val:DOCS.filter(d=>d.cat==='contract').length},
            {label:'Тех. задания', val:DOCS.filter(d=>d.cat==='tz').length},
            {label:'Акты', val:DOCS.filter(d=>d.cat==='acceptance_act').length},
            {label:'На проверке', val:DOCS.filter(d=>d.status==='review').length},
          ].map(s=>(
