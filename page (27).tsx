...
const ROLES=[
  ...
  {id:'r4',name:'Бухгалтерия',code:'accountant',users:1,desc:'Платежи, финансовая отчётность'},
  {id:'r5',name:'Руководство',code:'management',users:1,desc:'Полный просмотр, панель руководителя'},
