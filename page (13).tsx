...
const OVERDUE_PAYMENTS = [
  { id: 'op1', registry: 'РЗ-МО-2025-00089', title: 'Поставка бумаги', supplier: 'ЗАО КанцЛайф', sum: 85200, dueDate: '2025-06-05', overdueDays: 5, responsible: 'Петров А.В.' },
];

const OVERDUE_CONTRACTS = [
  { id: 'oc1', registry: 'РЗ-МО-2025-00134', title: 'Мебель для кабинетов', supplier: 'ООО ТехноОфис', sum: 408500, dueDate: '2025-06-13', overdueDays: -3, responsible: 'Орлова Т.В.' },
];

export default function MonitoringPage() {
  const overdueProc = MOCK_PROCUREMENTS.filter(p => p.isOverdue);
